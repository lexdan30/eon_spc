...
if( !empty( $param->empid  ) ){ $search = $search . " AND de.empid =  '".$param->empid ."' "; }
if( !empty( $param->class  ) ){ $search = $search . " AND de.business_unit =  '".$param->class ."' "; }
