...
$Qry->selected  = "empid,empname,work_date,late";
...
header('Content-Disposition: attachment; filename=PerfectAttendanceReport_'.$date.'.csv');
$output = fopen('php://output', 'w');
//fputcsv($output, array($param['company']));
fputcsv($output, array("New World Makati Hotel"));
fputcsv($output, array("Perfect Attendance Report"));
