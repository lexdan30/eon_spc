...
$Qry->selected  = "*";
$Qry->fields    = "id!=1 AND (sdate > '".$date1."' OR sdate IS NULL) AND etypeid = 1 ". $search . " ORDER BY empname LIMIT " .$param->pagination->pageSize. " OFFSET " . ($param->pagination->currentPage - 1) * $param->pagination->pageSize;
