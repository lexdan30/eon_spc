  ...
  const settings = {
    ...
    file_picker_callback (callback, value, meta) {
      ...
      if (meta.filetype === 'file') {
        callback('https://www.google.com/logos/google.webp', { text: 'My text' });
      }

      // Provide image and alt text for the image dialog
      if (meta.filetype === 'image') {
        callback('https://www.google.com/logos/google.webp', { alt: 'My alt text' });
      }

      // Provide alternative source and posted for the media dialog
      if (meta.filetype === 'media') {
        callback('movie.mp4', { source2: 'alt.ogg', poster: 'https://www.google.com/logos/google.webp' });
      }
    },
