...
if($param['appstat'] == '3' || empty($param['appstat'])){
	$Qry->table     = "vw_overtime_approvalpending"; 
}elseif($param['appstat'] == '1'){
	$Qry->table     = "vw_overtime_approvalapproved"; 
}elseif($param['appstat'] == '2'){
	$Qry->table     = "vw_overtime_approvaldisapproved"; 
...
$recFiltered = getTotalRows($con,$where,$param['appstat']);
...
function getTotalRows($con,$search,$stat){
	$Qry = new Query();	
	if($stat == '3' || empty($stat)){
		$Qry->table     = "vw_overtime_approvalpending"; 
	}elseif($stat == '1'){
		$Qry->table     = "vw_overtime_approvalapproved"; 
	}elseif($stat == '2'){
