...
$Qry->selected  = "tid,
                        ...
                        SUM((CASE 
                                ...
                                ELSE ut
                            END)) AS Undertime,
                        SUM(IF(leaveappstatus = 1 AND leaveidtype NOT IN(3,32) AND `leave` = 4 AND acthrs = 0.000000 AND idshift != 66,IF( absent - `leave` <= 0 ,0,absent - `leave`),IF(leaveidtype IN(3,32),`leave`,absent))) AS `Abs`,
