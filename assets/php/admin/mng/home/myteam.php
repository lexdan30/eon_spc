...
if($param->search != ''){
    $Qry->fields   = "(idunit in (" . $ids . ") OR idsuperior='".$param->accountid."')  AND id != '" . $param->accountid . "' AND etype = 'Active' AND empname LIKE '%" . $param->search . "%' ";
}else{
    $Qry->fields   = "(idunit in (" . $ids . ") OR idsuperior='".$param->accountid."') AND id != '" . $param->accountid . "'  AND etype = 'Active' ";
}
