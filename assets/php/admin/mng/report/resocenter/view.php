...
$Qry->selected  = "de.idunit, rc.empname, rc.reso_date, rc.reso_txt";
$Qry->fields    = "de.idunit IN (".$ids.") AND (rc.reso_date BETWEEN '".$pay_period['pay_start']."' AND '".$pay_period['pay_end']."')";
