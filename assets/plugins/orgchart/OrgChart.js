...
(OrgChart.prototype.load = function (t) {
            ...
            function (t) {
                ...
                if ((OrgChart.events.publish("render", [O, e]), (r = e.content), (r += O.ui.lonely(O.config)), C !== OrgChart.action.exporting)) {
                    ...
                    if (O._initialized) {
                        ...
                        (O.element.innerHTML = O.ui.css() + O.ui.exportMenuButton(O.config) + m ),
                    ...
                    C === OrgChart.action.centerNode
                        ...
                        : !a ||
                          !O.response ||
                          (a[0] == O.response.viewBox[0] && a[1] == O.response.viewBox[1] && a[2] == O.response.viewBox[2] && a[3] == O.response.viewBox[3]) ||
                        ...
                        ? 0 == g[0].length && (c || (x && x(), OrgChart.events.publish("redraw", [O]), (c = !0)))
                        : OrgChart.anim(O.getSvg(), { viewbox: a }, { viewbox: O.response.viewBox }, 500, OrgChart.anim.inOutPow, function () {
    ...
    (OrgChart.IT_IS_LONELY_HERE = '<g transform="translate(-100, 0)" style="cursor:pointer;"  control-add="control-add"><text fill="#e8867a">{link}</text></g>'),
    (OrgChart.RES = {}),
    ...
    //(OrgChart.MAX_NODES_MESS = "The trial has expired or 200 nodes limit was reached! <br /><a style='color: #e8867a;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>"),
    //(OrgChart.OFFLINE_MESS = "The evaluation version requires internet connection! <br /><a style='color: #e8867a;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>"),
        ...
        if (
            ...
            i ||
                s.addEventListener("focus", function () {
                    ...
                    (t.style.border = "1px solid #e8867a"), OrgChart.anim(t, { width: 10 }, { width: o.clientWidth }, 250, OrgChart.anim.inOutSin);
                }),
    ...
    (OrgChart.editUI.prototype._createDetailsView = function (t, e) {
        ...
        (o.className = "edit-tags"),
            ...
            Object.assign(i.style, { "background-color": "#e8867a", "min-height": "50px", textAlign: "center", position: "relative" }),
    ...
    (OrgChart.editUI.prototype._createEditView = function (t, e) {
        ...
        (l.className = "edit-assistant-button-content"),
            ...
            Object.assign(r.style, { "background-color": "#e8867a", "min-height": "50px", textAlign: "center", position: "relative" }),
        ...
        l.setAttribute("data-field-name", "isAssistant"),
            (l.innerHTML = '<div style="margin-top: 10px;display:inline-block;">' + OrgChart.ASSISTANT + '</div><label class="bg-switch"><input val type="checkbox" ' + s + '><span class="bg-slider round"></span></label>'),
            this.wrapperElement.appendChild(e),
            e.appendChild(r),
            e.appendChild(o),
            r.appendChild(a),
                        ...
                        if (void 0 === l[r].onClick)
                            if ("add" === r) {
                                ...
                                "remove" === r
                                    ...
                                    : "png" === r
                                    ? s.obj.exportPNG({ filename: "OrgChart.webp", expandChildren: !1, nodeId: n })
                                    : "csv" === r
                                    ? s.obj.exportCSV()
            ...
            (this.obj = t),
                ...
                e.layout &&
                    ...
                    (this.layouts.innerHTML =
                        '<svg data-layout="normal" style="cursor: pointer;" width="110" height="100"><rect fill="#e8867a" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="41" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="88" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="32" y1="35" y2="41" stroke-width="1"></line><line stroke="#000000" x1="88" x2="88" y1="35" y2="41" stroke-width="1"></line></svg><svg data-layout="treeRightOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#e8867a" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="40" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="40" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="35" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="35" x2="35" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#e8867a" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="mixed" style="cursor: pointer;" width="110" height="100"><rect fill="#e8867a" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="35" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="35" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="41" stroke-width="1"></line><line stroke="#000000" x1="60" x2="60" y1="68" y2="73" stroke-width="1"></line></svg><svg data-layout="tree" style="cursor: pointer;" width="110" height="100"><rect fill="#e8867a" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="73" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="86" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="54" y2="54" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="86" y2="86" stroke-width="1"></line></svg>'),
    ...
    // }),
    (OrgChart.icon = {}),
    (OrgChart.icon.webp = function (t, e, r) {
        return (
            '<svg width="' +
            t +
            '" height="' +
            ...
            var L = function (t, e) {
                ...
                a = function (t) {
                    if (_) {
                        ...
                        if (a.left || a.right || a.up || a.down) {
                            ...
                            var m = (e.x - _.x) / A,
                                C = (e.y - _.y) / A;
                            if (((k[4] = S + m), (k[5] = I + C), !y._dragEventFired && (Math.abs(e.x - _.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(e.y - _.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                                !1 === OrgChart.events.publish("drag", [b, c]) && M(), (y._dragEventFired = !0);
                            E.setAttribute("transform", "matrix(" + k.toString() + ")");
                        }
                    }
                },
                M = function (t) {
                    if (
                        ...
                        return w.removeChild(E), (b._gragStartedId = null), void OrgChart.events.publish("drop", [b, x.id]);
                    var e = b.getNode(O);
...
(OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    (OrgChart.searchUI.prototype._serverSearch = function (t) {
        for (
            var e = this,
                ...
                a = OrgChart._search.search(this.obj.config.nodes, t, this.obj.config.searchFields, this.obj.config.searchFields, this.obj.config.searchDisplayField, this.obj.config.searchFieldsWeight),
    ...
    (OrgChart.searchUI.createSearchIcon = function (t) {
        return (
            '<div data-id="search-icon" style="padding:5px; position:absolute;top:' + t + "px;left:" + t + 'px;border:1px solid transparent;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32, "#757575") + "</div></div></div>"
        );
    }),
    void 0 === OrgChart && (OrgChart = {}),
    ...
    (OrgChart.server.prototype.read = function (h, d, c, g, p, f, u, m) {
        ...
        OrgChart.state._get(this.config.state, d, c, function (t) {
            ...
            if (h) {
                ...
                p != OrgChart.action.exporting && ((C.maxX = r), (C.maxY = i), (C.minX = a), (C.minY = n), (C.roots = l), (C.nodes = s), (C.visibleNodeIds = e.visibleNodeIds)),
                ...
                (C.oldNodes = s || null),
                    C._read(function (t) {
                        ...
                        (e.notif = t.limit),
                            ...
                            p != OrgChart.action.exporting && ((C.maxX = r), (C.maxY = i), (C.minX = a), (C.minY = n), (C.roots = l), (C.nodes = s), (C.visibleNodeIds = e.visibleNodeIds), (C.bordersByRootIdAndLevel = o)),
                            u(e);
                    }, m);
        });
    }),
        ...
        null == r && (r = OrgChart.local),
            r._setPositions(
                ...
                function (t) {
                    ...
                    for (var r = { minX: null, minY: null, maxX: null, maxY: null }, i = {}, a = 0; a < s.length; a++) OrgChart.server._setMinMaxXYAdjustifyIterate(s[a], s[a], r, 0, i, e, o.config.orientation);
    ...
    (OrgChart.server._initNode = function (t, e, r, i, a, n, o, l, s, h, d) {
        ...
        for (var g = 0; g < t.childrenIds.length; g++) {
            ...
            OrgChart.server._setCollpasedProperty(p, c, s, l, a, i, d),
                p.collapsed ||
                    ((p.parent = t), (-1 == p.tags.indexOf("left-partner") && -1 == p.tags.indexOf("right-partner") && -1 == p.tags.indexOf("partner") && null == p.ppid) || (-1 == h.indexOf(t.id) && h.push(t.id)), t.children.push(p));
        }
        if (
            (t.min || a != OrgChart.action.minimize || s.id != t.id || (t.min = !0), !0 === t.min && a == OrgChart.action.maximize && s.id == t.id && (t.min = !1), a == OrgChart.action.init && null != d && (t.min = d.min.has(t.id)), !t.min)
        )
    ...
    (OrgChart.server._createNodes = function (a, t, e, r, i, n) {
        ...
        if (null != a.roots) {
            ...
            for (d = 0; d < a.roots.length; d++) {
                var O = l[a.roots[d]];
                if (O && e == OrgChart.action.centerNode) {
                    for (var v = O; null != v.pid || null != v.stpid; ) v = null == v.pid && null != v.stpid ? l[v.stpid] : l[v.pid];
                    for (var b = l[r.id]; null != b.pid || null != b.stpid; ) b = null == b.pid && null != b.stpid ? l[b.stpid] : l[b.pid];
                    v == b && (O = v);
                }
                if (O) {
                    for (var w = !1, _ = 0; _ < h.length; _++)
                        if (h[_].id == O.id) {
                            w = !0;
                            break;
                        }
                    if (!w) {
                        if (!OrgChart.isNullOrEmpty(O.pid)) -1 < (X = (y = l[O.pid]).childrenIds.indexOf(O.id)) && y.childrenIds.splice(X, 1), (O.pid = null);
                        h.push(O);
                    }
                }
            }
            a.roots = [];
            for (d = 0; d < h.length; d++) a.roots.push(h[d].id);
        }
        ...
        if (e == OrgChart.action.init && a.expand && a.expand.nodes && null == n)
            for (d = 0; d < a.expand.nodes.length; d++) {
                ...
                for (!0 === a.expand.allChildren && OrgChart.server._addExpandedNodeIdsIterate(f, l, k); f; ) k.push(f.id), null == f.pid && null != f.stpid ? ((f = l[f.stpid]).min = !1) : (f = l[f.pid]);
            }
        else if (e == OrgChart.action.centerNode) {
            for (var S = l[r.id]; S; ) {
                if ((k.push(S.id), r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && S))
                    for (d = 0; d < S.childrenIds.length; d++) {
                        (Y = l[S.childrenIds[d]]).collapsed = !0;
                    }
                null == S.pid && null != S.stpid ? ((S = l[S.stpid]).min = !1) : (S = l[S.pid]);
            }
            S = l[r.id];
            if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
                for (d = 0; d < S.childrenIds.length; d++) {
                    (A = l[S.childrenIds[d]]).collapsed = !1;
                    for (var I = 0; I < A.childrenIds.length; I++) {
                        l[A.childrenIds[I]].collapsed = !0;
                    }
                }
            if (r.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
                if ((y = l[S.pid]))
                    for (d = 0; d < y.childrenIds.length; d++) {
                        var A;
                        if ((A = l[y.childrenIds[d]]) != S) {
                            A.collapsed = !1;
                            for (I = 0; I < A.childrenIds.length; I++) {
                                l[A.childrenIds[I]].collapsed = !0;
                            }
                        }
                    }
        } else if (e == OrgChart.action.insert) for (f = l[r.insertedNodeId]; f; ) k.push(f.id), null == f.pid && null != f.stpid ? ((f = l[f.stpid]).min = !1) : (f = l[f.pid]);
        var E = [],
            L = {},
            M = [],
            N = {},
            T = [];
        for (d = 0; d < h.length; d++) OrgChart.server._iterate(h[d], h[d], l, 0, E, L, M, N, "", t, a, e, k, r, T, n);
        ...
        for (d = 0; d < T.length; d++) {
            ...
            for (I = 0; I < f.children.length; I++) {
                (Y = f.children[I]).isAssistant ||
                    (-1 != Y.tags.indexOf("right-partner")
                        ? ((Y.isPartner = 1), (Y.children = []), P.push(Y.id))
                        : -1 != Y.tags.indexOf("left-partner")
                        ? ((Y.isPartner = 2), (Y.children = []), F.push(Y.id))
                        : -1 == Y.tags.indexOf("partner") || H % 2
                        ? -1 != Y.tags.indexOf("partner") && H % 2
                            ? ((Y.isPartner = 2), (Y.children = []), F.push(Y.id), H++)
                            : null != Y.ppid
                            ? (z[Y.ppid] || (z[Y.ppid] = []), z[Y.ppid].push(Y.id))
                            : B.push(Y.id)
                        : ((Y.isPartner = 1), (Y.children = []), P.push(Y.id), H++));
            }
            f.children = [];
            ...
            for (I = F.length - 1; 0 <= I; I--) if (z[F[I]]) for (_ = 0; _ < z[F[I]].length; _++) f.children.push(l[z[F[I]][_]]), R++, -1 == D.indexOf(F[I]) && D.push(F[I]);
            for (I = 0; I < B.length; I++) {
                Y = l[B[I]];
                f.children.push(Y);
            }
            for (I = 0; I < P.length; I++) if (z[P[I]]) for (_ = 0; _ < z[P[I]].length; _++) f.children.push(l[z[P[I]][_]]), j++, -1 == U.indexOf(P[I]) && U.push(P[I]);
            (f.partnerSeparation = Math.max(D.length, U.length) * a.partnerChildrenSplitSeparation + a.minPartnerSeparation),
                B.length || !R || j
                    ? B.length || R || !j
                        ? B.length || 1 != R || 1 != j
                            ? B.length || R || j
        ...
        for (d = 0; d < M.length; d++) {
            if ((at = t[(f = l[M[d]]).lcn ? f.lcn : "base"]).layout == OrgChart.normal || !N[f.pid])
                for (I = 0; I < f.subLevels; I++) {
                    var X,
                        q = new OrgChart.node(f.id + "_sub_level_index_" + I, f.pid, [], "subLevel");
                    if ((OrgChart.server._initDinamicNode(q, f.lcn), (y = f.parent)))
                        -1 < (X = y.children.indexOf(f)) && (y.children.splice(X, 1), y.children.splice(X, 0, q)), q.children.push(f), (q.parent = y), (f.parent = q), (l[q.id] = q);
                }
        }
        for (var V in L) {
            (y = l[V]).hasAssistants = !0;
            q = new OrgChart.node(y.id + "_split_0", y.id, ["assistant"], "split");
            OrgChart.server._initDinamicNode(q, y.lcn, !0), (l[q.id] = q);
            var W = [];
            for (I = y.children.length - 1; 0 <= I; I--) {
                (Y = y.children[I]).isAssistant ? ((Y.parent = null), y.children.splice(I, 1), W.splice(0, 0, Y.id)) : Y.isPartner || ((Y.parent = q).children.unshift(Y), y.children.splice(I, 1));
            }
            if (W.length % 2) {
                var G = l[W[W.length - 1]],
                    K = new OrgChart.node(G.id + "_mirror", G.pid, [], "mirror");
                OrgChart.server._initDinamicNode(K, G.lcn, !0), (G._m = K.id), (K.isAssistant = !0), (K.w = G.w), (K.h = G.h), (l[K.id] = K), W.splice(W.length - 1, 0, K.id);
            }
            var J = 1;
            for (I = W.length - 1; 0 <= I; I--)
                if (I % 2 && I != W.length - 1) {
                    var Z = new OrgChart.node(y.id + "_split_" + J, null, [], "split");
                    OrgChart.server._initDinamicNode(Z, y.lcn, !0), (l[Z.id] = Z), W.splice(I, 0, Z.id), J++;
                } else I % 2 && W.splice(I, 0, q.id);
            for (I = 0; I < W.length; I += 3) {
                ...
                var $ = l[W[I]],
                    tt = l[W[I + 1]],
                    et = l[W[I + 2]];
                ($.parent = Q), (tt.parent = Q), (et.parent = Q).children.push($), Q.children.push(tt), Q.children.push(et);
            }
        }
        var rt = !1;
        for (var it in t) {
            if ((at = t[it]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset) {
                rt = !0;
                break;
            }
        }
        if (rt)
            for (var V in N) {
                var at;
                if ((at = t[(y = l[V]).lcn ? y.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset) {
                    var nt = { pnode: y, layout: at.layout, childrenIds: N[V] };
                    if ((OrgChart.events.publish("layout", [nt]), nt.layout == OrgChart.mixed)) {
                        var ot = nt.childrenIds;
                        for (d = ot.length - 1; 0 <= d; d--) {
                            if (((y = (Y = l[ot[d]]).parent), (Y.layout = OrgChart.mixed), 0 < d)) {
                                for (I = y.children.length - 1; 0 <= I; I--) Y.id == y.children[I].id && y.children.splice(I, 1);
                                var lt = l[ot[d - 1]];
                                (Y.parent = lt), (Y.layout = OrgChart.mixed), lt.children.push(Y);
                            }
                        }
                    } else if (nt.layout == OrgChart.tree || nt.layout == OrgChart.treeRightOffset || nt.layout == OrgChart.treeLeftOffset) {
                        q = new OrgChart.node(y.id + "_split_0", y.id, [], "split");
                        OrgChart.server._initDinamicNode(q, y.lcn), ((l[q.id] = q).layout = OrgChart.tree);
                        var st = [];
                        for (d = nt.childrenIds.length - 1; 0 <= d; d--) {
                            for (Y = l[nt.childrenIds[d]], I = 0; I < y.children.length; I++) y.children[I].id == Y.id && y.children.splice(I, 1);
                            if (((Y.parent = null), (Y.layout = OrgChart.tree), nt.layout == OrgChart.treeRightOffset && st.splice(0, 0, Y.id), nt.layout == OrgChart.treeLeftOffset || nt.layout == OrgChart.treeRightOffset)) {
                                var ht = new OrgChart.node(Y.id + "_mirror", null, [], "mirror");
                                OrgChart.server._initDinamicNode(ht, Y.lcn), (ht.layout = OrgChart.tree), (l[ht.id] = ht), st.splice(0, 0, ht.id);
                            }
                            nt.layout != OrgChart.treeRightOffset && st.splice(0, 0, Y.id);
                        }
                        for (J = 1, I = st.length - 1; 0 <= I; I--)
                            if (I % 2 && I != st.length - 1) {
                                Z = new OrgChart.node(y.id + "_split_" + J, null, [], "split");
                                OrgChart.server._initDinamicNode(Z, y.lcn), (Z.layout = OrgChart.tree), (l[Z.id] = Z), st.splice(I, 0, Z.id), J++;
                            } else I % 2 && st.splice(I, 0, q.id);
                        for (I = 0; I < st.length; I += 3) {
                            Q = null;
                            0 == I && (Q = y);
                            ($ = l[st[I]]), (tt = l[st[I + 1]]), (et = l[st[I + 2]]);
                            0 != I && (Q = l[st[I - 3]]),
                                0 == I || tt || (Q = l[st[I - 2]]),
                                ($.parent = Q).children.push($),
                                tt && (0 != I && (Q = l[st[I - 2]]), (tt.parent = Q).children.push(tt)),
                                et && (0 != I && (Q = l[st[I - 1]]), (et.parent = Q).children.push(et));
                        }
                    }
                }
            }
    ...
    (OrgChart.server._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f) {
        ...
        return {animations: y, boundary: C, viewBox: s, visibleNodeIds: m, nodes: g, allFields: OrgChart.server.getAllFields(i) };
    }),
    ...
    (OrgChart.templates.ana = {
        ...
        pointer:
            '<g data-pointer="pointer" transform="matrix(0,0,0,0,100,100)"><radialGradient id="pointerGradient"><stop stop-color="#ffffff" offset="0" /><stop stop-color="#C1C1C1" offset="1" /></radialGradient><circle cx="16" cy="16" r="16" stroke-width="1" stroke="#acacac" fill="url(#pointerGradient)"></circle></g>',
        node: '<rect x="0" y="0" height="{h}" width="{w}" fill="#e8867a" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>',
        plus:
            '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
        minus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line>',
        nodeMenuButton:
    ...
    (OrgChart.templates.group.ripple = { radius: 0, color: "#aeaeae" }),
    ...
    (OrgChart.templates.ula.field_0 = '<text width="145" style="font-size: 18px;" fill="#e8867a" x="100" y="55">{val}</text>'),
    ...
    (OrgChart.templates.ula.node = '<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="250" y2="0" stroke-width="2" stroke="#e8867a"></line>'),
    ...
    (OrgChart.templates.ula.menu =
        '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,12)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#ffffff" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#e8867a"></circle><circle cx="7" cy="0" r="2" fill="#e8867a"></circle><circle cx="14" cy="0" r="2" fill="#e8867a"></circle></g>'),
    ...
    (OrgChart.templates.belinda.node = '<circle cx="90" cy="90" r="90" fill="#e8867a" stroke-width="1" stroke="#aeaeae"></circle>'),
    ...
    (OrgChart.templates.rony.field_0 = '<text width="165" style="font-size: 18px;" fill="#e8867a" x="90" y="40" text-anchor="middle">{val}</text>'),
    ...
    (OrgChart.templates.rony.link = '<path stroke="#e8867a" stroke-width="1px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>'),
    (OrgChart.templates.rony.plus =
        '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#e8867a" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#e8867a"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#e8867a"></line>'),
    (OrgChart.templates.rony.minus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#e8867a" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#e8867a"></line>'),
    ...
    (OrgChart.templates.mery.node = '<rect x="0" y="0" height="120" width="250" fill="#ffffff" stroke-width="1" stroke="#686868" rx="50" ry="50"></rect><rect x="0" y="45" height="30" width="250" fill="#e8867a" stroke-width="1"></rect>'),
    ...
    (OrgChart.templates.mery.field_0 = '<text width="220" style="font-size: 18px;" fill="#e8867a" x="125" y="30" text-anchor="middle">{val}</text>'),
    (OrgChart.templates.mery.field_1 = '<text width="220" style="font-size: 14px;" fill="#e8867a" x="125" y="100" text-anchor="middle">{val}</text>'),
    ...
    (OrgChart.templates.polina.node = '<rect x="0" y="0" height="80" width="300" fill="#e8867a" stroke-width="1" stroke="#686868" rx="40" ry="40"></rect>'),
    ...
    (OrgChart.templates.mila.node =
        '<rect x="0" y="0" height="120" width="250" fill="#e8867a" stroke-width="1" stroke="#aeaeae"></rect><rect x="-5" y="70" height="30" width="260" fill="#ffffff" stroke-width="1" stroke="#e8867a"></rect><line x1="-5" x2="0" y1="100" y2="105" stroke-width="1" stroke="#e8867a"/><line x1="255" x2="250" y1="100" y2="105" stroke-width="1" stroke="#e8867a"/>'),
    (OrgChart.templates.mila.img_0 = '<image preserveAspectRatio="xMidYMid slice" xlink:href="{val}" x="20" y="5"  width="64" height="64"></image>'),
    (OrgChart.templates.mila.field_0 = '<text width="240" style="font-size: 18px;" fill="#e8867a" x="125" y="92" text-anchor="middle">{val}</text>'),
    ...
    (OrgChart.templates.diva.node = '<rect x="0" y="80" height="90" width="200" fill="#e8867a"></rect><circle cx="100" cy="50" fill="#ffffff" r="50" stroke="#e8867a" stroke-width="2"></circle>'),
    ...
    (OrgChart.templates.diva.pointer =
        '<g data-pointer="pointer" transform="matrix(0,0,0,0,100,100)"><radialGradient id="pointerGradient"><stop stop-color="#ffffff" offset="0" /><stop stop-color="#e8867a" offset="1" /></radialGradient><circle cx="16" cy="16" r="16" stroke-width="1" stroke="#acacac" fill="url(#pointerGradient)"></circle></g>'),
    ...
    (OrgChart.templates.isla.node =
        '<rect filter="url(#isla-shadow)" x="0" y="20" rx="5" ry="5" height="100" width="180" fill="#FFF" stroke-width="1" stroke="#e8867a" ></rect><rect x="25" y="75" rx="10" ry="10" height="20" width="130" fill="#e8867a" stroke-width="3" stroke="#e8867a"></rect><rect fill="#ffffff" stroke="#e8867a" stroke-width="1" x="70" y="0" rx="13" ry="13" width="40" height="40"></rect><circle stroke="#FFCA28" stroke-width="3" fill="none" cx="90" cy="12" r="8"></circle><path d="M75,34 C75,17 105,17 105,34" stroke="#FFCA28" stroke-width="3" fill="none"></path>'),
    (OrgChart.templates.isla.field_0 = '<text width="120" style="font-size: 12px;" fill="#fff" x="90" y="90" text-anchor="middle">{val}</text>'),
    (OrgChart.templates.isla.field_1 = '<text width="160" style="font-size: 13px;" fill="#e8867a" x="90" y="64" text-anchor="middle">{val}</text>'),
    (OrgChart.templates.isla.img_0 =
        '<clipPath id="{randId}"><rect filter="url(#isla-shadow)" fill="#ffffff" stroke="#e8867a" stroke-width="1" x="70" y="0" rx="13" ry="13" width="40" height="40"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="70" y="0"  width="40" height="40"></image>'),
    ...
    (OrgChart.templates.deborah.node = '<rect x="0" y="0" height="150" width="150" fill="#e8867a" stroke-width="1" stroke="#686868" rx="15" ry="15"></rect>'),
    (OrgChart.templates.deborah.img_0 =
        '<clipPath id="{randId}"><rect fill="#ffffff" stroke="#e8867a" stroke-width="1" x="5" y="5" rx="15" ry="15" width="140" height="140"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="5" y="5"  width="140" height="140"></image><rect x="3" y="5" height="30" width="144" fill="#e8867a" opacity="0.5" rx="3" ry="3"></rect><rect x="3" y="115" height="30" width="144" fill="#e8867a" opacity="0.5" rx="3" ry="3"></rect>'),
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == o && (o = i.nodeBinding);
            var g = { node: t, data: e };
            for (var p in o) {
                var f = o[p];
                if (e) {
                    var u = e[f];
                    if (("function" == typeof f && (u = f(h, t, e)), (g.value = u), (g.element = d[p]), (g.name = f), !1 !== OrgChart.events.publish("field", [h, g])))
                        if (null != g.value && null != g.value && null != g.element)
                            c += (OrgChart._lblIsImg(i, p) || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element)), g.element.replace("{val}", g.value))
            ...
            var y = "";
            t.lcn && (y = 'lcn="' + t.lcn + '"');
            var x = OrgChart.nodeOpenTag.replace("{lcn}", y).replace("{id}", t.id).replace("{class}", C).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y),
                O = OrgChart._getOpacity(r, t);
            ((x = x.replace("{opacity}", O)), null != i.nodeMenu && "split" != t.templateName && l !== OrgChart.action.exporting) &&
                (c += d.nodeMenuButton
                    .replace("{id}", t.id)
                    .replace("{cw}", t.w / 2)
                    .replace("{ew}", t.w - (t.padding ? t.padding[1] : 0)));
            return (c = x + c + OrgChart.grCloseTag);
        },
        ...
        link: function (t, e, r, i, a) {
            ...
            var d = 0,
                ...
                p = void 0;
            if (t.hasPartners) {
                p = { ids: [], indexes: {}, ppnodes: {}, lastLeft: null, firstRight: null, maxSidePartnersWithChildren: 0, rightIds: [], leftIds: [], partnerChildrenSplitSeparation: e.config.partnerChildrenSplitSeparation };
                    ...
                    null != (m = t.children[f]).ppid && (u = a[m.ppid]),
                        u
                            ? ((p.ppnodes[m.id] = u),
                              p.ids.push(m.id),
                              1 == u.isPartner
                                  ? (-1 == p.rightIds.indexOf(u.id) && p.rightIds.push(u.id), (p.indexes[m.id] = p.rightIds.indexOf(u.id)), p.firstRight || (p.firstRight = m))
                                  : 2 == u.isPartner && (-1 == p.leftIds.indexOf(u.id) && p.leftIds.push(u.id), (p.indexes[m.id] = p.leftIds.indexOf(u.id)), (p.lastLeft = m)))
                            : m.isPartner || ((p.lastLeft = m), p.firstRight || (p.firstRight = m));
                }
                (p.maxSidePartnersWithChildren = Math.max(p.leftIds.length, p.rightIds.length)),
                    (d = 0 == p.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + p.partnerChildrenSplitSeparation * p.maxSidePartnersWithChildren + p.partnerChildrenSplitSeparation / 2);
            }
            for (f = 0; f < t.children.length; f++) {
                ...
                if (-1 != x.indexOf("{rounded}"))
                    ...
                    x =
                        -1 != x.indexOf("{edge}")
                            ? x.replace("{edge}", "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd)
                            : -1 != x.indexOf("{curve}")
                            ? x.replace("{curve}", "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd)
                            : x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd);
                s.push(
    ...
    (OrgChart.loading.show = function (t) {
        ...
        (e.id = "bg-loading"),
            (e.innerHTML =
                '<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.bg-loading-dots div {margin: 10px;}      .bg-dot-1 {background-color: #e8867a;}.bg-dot-2 {background-color: #F57C00;}.bg-dot-3 {background-color: #FFCA28;}      .bg-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.bg-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.bg-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.bg-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="bg-loading-dots"><div class="bg-loading-dots--dot bg-dot-1"></div><div class="bg-loading-dots--dot bg-dot-2"></div><div class="bg-loading-dots--dot bg-dot-3"></div></div>'),
        ...
        for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (-1 != e.res.visibleNodeIds.indexOf(h.from) && -1 != e.res.visibleNodeIds.indexOf(h.to)) {
                ...
                switch (this.config.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        y <= x ? ((b = 1), (m.x = y + d.w / 10), (C.x = x - c.w / 10)) : ((b = -1), (m.x = y - d.w / 10), (C.x = x + c.w / 10)),
    ...
    (OrgChart.clinkTemplates.blue = {
        defs:
            '<marker id="arrowBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#e8867a" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#e8867a" /></marker>',
        link: '<path marker-start="url(#dotBlue)" marker-end="url(#arrowBlue)" stroke="#e8867a" stroke-width="2" fill="none" d="{d}" />',
        label: '<text fill="#e8867a"  text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    }),
    ...
    (OrgChart.prototype._slinks = function (S, t) {
        var I = "",
            A = this.getScale(),
            E = t.res.boundary;
        function e(t, e, r) {
            ...
            var s = OrgChart.t(t.templateName, t.min, A),
                h = l.levelSeparation;
            ...
            if (t.level == e.level)
                switch (((a = e), l.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        i.push([d.p, d.q]), i.push([d.p, d.q - h / 3]), (s = OrgChart.t(a.templateName, a.min, A)), i.push([a.x + a.w / 2 + s.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y]);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (d.q = t.y + t.h),
                            ...
                            (s = OrgChart.t(a.templateName, a.min, A)),
                ...
                switch (l.orientation) {
                    ...
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (d.p = t.x + t.w), (d.q = t.y + t.h / 2 + s.expandCollapseSize), (d.r = E.maxX + h), (d.s = t.y + t.h / 2 + s.expandCollapseSize), i.push([d.p, d.q]), i.push([t.x + t.w + h / 3, d.q]);
                }
                for (var c = t; null == a; ) {
                    var g = !1,
                        p = c.parent,
                ...
                switch (((s = OrgChart.t(a.templateName, a.min, A)), i.splice(i.length - 1, 1), l.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
            ...
            var b = i.join(" ");
            if (((I += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + s.link.replaceAll("{d}", b)), L.label)) {
                var w = s.label.replace("{x}", x.x).replace("{y}", x.y).replace("{val}", L.label),
            ...
            I += OrgChart.grCloseTag;
        }
        for (var r = 0; r < this.config.slinks.length; r++) {
            var L = this.config.slinks[r];
            if (-1 != t.res.visibleNodeIds.indexOf(L.from) && -1 != t.res.visibleNodeIds.indexOf(L.to)) {
                var i = S.getNode(L.from),
                    a = S.getNode(L.to);
                i.level >= a.level ? e(i, a, !1) : e(a, i, !0);
            }
        }
        t.content += I;
    }),
    ...
    (OrgChart.slinkTemplates.blue = {
        defs:
            '<marker id="arrowSlinkBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#e8867a" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#e8867a" /></marker>',
        link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#e8867a" stroke-width="2" fill="none" d="{d}" />',
        label: '<text fill="#e8867a" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
        labelPosition: "middle",
    }),
        ...
        if (t.config.miniMap) {
            ...
            !(function t(e, r) {
                if (Array.isArray(r)) for (var i = 0; i < r.length; i++) t(e, r[i]);
                    ...
                    for (a.fillStyle = OrgChart.miniMap.colors[3], a.beginPath(), a.lineWidth = "0.5", a.fillRect(r.x, r.y, r.w, r.h), a.strokeRect(r.x, r.y, r.w, r.h), i = 0; i < r.stChildrenIds.length; i++)
                        h++,
                            d.includes(r.id) ||
            ...
            var c = t.getViewBox()[0],
                ...
                p = t.getViewBox()[2],
                f = t.getViewBox()[3];
            (a.lineWidth = 0.5 / o), (a.strokeStyle = "#f57c00"), a.strokeRect(c, g, p, f), (a.globalAlpha = 0.4), (a.fillStyle = OrgChart.miniMap.selectorBackgroundColor), a.fillRect(c, g, p, f);
        }
    }),
    (OrgChart.miniMap = {}),
    ...
    (OrgChart._search.addNodeToResult = function (t, e, r, i, a, n) {
        ...
        null != i && (OrgChart.isNullOrEmpty(o.__score) && (o.__score = i.__score), OrgChart.isNullOrEmpty(o.__searchField) && (o.__searchField = a), OrgChart.isNullOrEmpty(o.__searchMarks) && (o.__searchMarks = i.__searchMarks)),
            t.push(o);
    }),
        ...
        if (t.config.state) {
            ...
            !(function t(e) {
                if (Array.isArray(e)) for (var r = 0; r < e.length; r++) t(e[r]);
                    ...
                    for (("string" != typeof e.id || ("string" == typeof e.id && -1 == e.id.indexOf("split") && -1 == e.id.indexOf("mirror"))) && (i.push(e.id), 1 == e.min && a.push(e.id)), r = 0; r < e.stChildren.length; r++)
                        t(e.stChildren[r]);
    ...
    (OrgChart.prototype.magnify = function (t, e, r, i, a) {
        ...
        if (n || o) {
            ...
            if ((l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), OrgChart._magnify[t]), r))
