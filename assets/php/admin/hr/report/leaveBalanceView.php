...
$Qry            = new Query();  
$Qry->table = "(SELECT id, empid, empname, lname, fname, mname, etypeid, business_unit, unittype, idunit, post, concat_sup_fname_lname, idemptype FROM vw_dataemployees) AS de LEFT JOIN
(SELECT idacct, entitle, used, carry_over, balance, conversion, idleave FROM vw_leavesummary) AS al ON (de.id=al.idacct)";
...
$Qry->fields    = "de.id!=1 and al.entitle is not null ". $search . "and de.idemptype!= 3 GROUP BY de.empid order by de.lname";
