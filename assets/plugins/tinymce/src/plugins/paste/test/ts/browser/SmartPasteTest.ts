...
UnitTest.asynctest('tinymce.plugins.paste.browser.ImagePasteTest', function () {
  ...
  suite.test('isImageUrl', function () {
    ...
    LegacyUnit.equal(SmartPaste.isImageUrl('http://www.site.com/dir-name/file.webp'), true);
    LegacyUnit.equal(SmartPaste.isImageUrl('http://www.site.com/dir-name/file.webp'), true);
  ...
  suite.test('smart paste image url', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, { content: 'http://www.site.com/my.webp' });
    LegacyUnit.equal(editor.getContent(), '<p>a<img src="http://www.site.com/my.webp" />bc</p>');
    LegacyUnit.equal(editor.undoManager.data.length, 3);
  });
  ...
  suite.test('smart paste option disabled', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, { content: 'http://www.site.com/my.webp' });
    LegacyUnit.equal(editor.getContent(), '<p>ahttp://www.site.com/my.webpbc</p>');
