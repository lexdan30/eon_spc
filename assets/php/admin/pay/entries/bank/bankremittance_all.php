...
$Qry->fields = "pr.idpayperiod = '" . $idpayperiod['period']['id'] . "' AND pr.type = '" . $idpayperiod['period']['type'] . "' AND pr.idpaygrp = '" .$param->data->paygroup. "'";
...
if(mysqli_num_rows($rs)>= 1){
	...
	$return = json_encode(array("err"=>$Qry->fields));
...
function getTotalamount($con,$param){
    ...
    $Qry->fields = "net_amount > 0 AND idpayperiod = '" . $idpayperiod['period']['id'] . "' AND type = '" . $idpayperiod['period']['type'] . "' AND idpaygrp = '" .$param->data->paygroup. "'";
