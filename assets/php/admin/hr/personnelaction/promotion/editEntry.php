...
require_once('../../../../classPhp.php'); 
    ...
    if(!empty($param['accountid'])){
		...
		if( checkFormProgressPromotion($con, $param['form_id'], $param['entry']['id']) ){
			$return = json_encode(array('status'=>'error-prog'));
			print $return;	
			mysqli_close($con);
			return;
		}
        ...
        $Qry->selected 	= " effectivedate 			= 	'".$param['entry']['effectivedate']."',
                            newdeptname				=	'".$param['entry']['str_dept']."',
							newiddept				=	'".$param['entry']['newdeptname']."',
							newdeptmanager			=	'".$param['entry']['str_mngr']."',
							newidmngr				=	'".$param['entry']['newdeptmanager']."',
							newimmediatesupervisor	=	'".$param['entry']['str_super']."',
							newidsuperior			=	'".$param['entry']['newimmediatesupervisor']."',
                            newsection				=	'".$param['entry']['str_section']."',
							newidsection			=	'".$param['entry']['newsection']."',
                            newempstatus			=	'".$param['entry']['newempstatus']."',
                            newjobcode				=	'".$param['entry']['newjobcode']."',
                            newjoblevel				=	'".$param['entry']['newjoblevel']."',
                            newpositiontitle		=	'".$param['entry']['newpositiontitle']."',
                            newpaygroup				=	'".$param['entry']['newpaygroup']."',
							newlabortype			=	'".$param['entry']['newlabortype']."',
							newbasepay				=	'".$param['entry']['newbasepay']."',
							newriceallowance		=	'".$param['entry']['newriceallowance']."',
							newclothingallowance	=	'".$param['entry']['newclothingallowance']."',
							newlaundryallowance		=	'".$param['entry']['newlaundryallowance']."',
