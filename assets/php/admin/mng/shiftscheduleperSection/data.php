...
if( !empty( $param['accountid'] ) ){ $search=" AND idhead =   '".$param['accountid']."'"; }
...
$Qry->selected  = "id, `name`, alias, idhead, idunder, unittype, isactive, stype, shead, assignsched, stat, site";
