...
if(mysqli_num_rows($rs)>= 1){
    if($row=mysqli_fetch_array($rs)){
		...
		if($row['sss_deduct1'] == '0'){
			$sss1 = false;
		}else{
			$sss1 = true;
		}
		if($row['sss_deduct2'] == '0'){
			$sss2 = false;
		}else{
			$sss2 = true;
		}
		if($row['ibig_deduct1'] == '0'){
			$pagibig1 = false;
		}else{
			$pagibig1 = true;
		}
		if($row['ibig_deduct2'] == '0'){
			$pagibig2 = false;
		}else{
			$pagibig2 = true;
		}
		if($row['health_deduct1'] == '0'){
			$philhealth1 = false;
		}else{
			$philhealth1 = true;
		}
		if($row['health_deduct2'] == '0'){
			$philhealth2 = false;
		}else{
			$philhealth2 = true;
		}
		if($row['rev_deduct1'] == '0'){
			$rev1 = false;
		}else{
			$rev1 = true;
		}
		if($row['rev_deduct2'] == '0'){
			$rev2 = false;
		}else{
			$rev2 = true;
		}

		//$sss1 = $row['sss_deduct1']=='0' ? false : true;
		//$sss2 = $row['sss_deduct2']=='0' ? false : true;
		//$pagibig1 = $row['ibig_deduct1']=='0' ? false : true;
		//$pagibig2 = $row['ibig_deduct2']=='0' ? false : true;
		// $philhealth1 = $row['health_deduct1']=='0' ? false : true;
		// $philhealth2 = $row['health_deduct2']=='0' ? false : true;
		// $rev1 = $row['rev_deduct1']=='0' ? false : true;
		// $rev2 = $row['rev_deduct2']=='0' ? false : true;
		if(!empty($row['idbank'])){
			$bank = $row['idbank'];
		}else{
			$bank = '1'; // default request by kajima
		}
        ...
        $data = array( 
			...
			"empstat"		=> $row['empstat'],
			"batchnum"		=> explode(",",$row['batchnum']),
			"contract_sdate"=> $row['contract_sdate'],
			"contract_fdate"=> $row['contract_fdate'],
			...
			"salary_old"		=> number_format($row['salary'],2),
			"product"		=> $row['product'],
			...
			"allallowance2"	=> getAccountAllowance2($con),
			...
			"pagibig1"	=> $pagibig1 ,
			"pagibig2"	=>$pagibig2 ,
			"philhealth1"=>  $philhealth1 ,
			"philhealth2"=>  $philhealth2 ,
			"rev1"	=> $rev1 ,
			"rev2"	=> $rev2 ,
			"isprevemp"		=> array("id"=> (int)$row['isprevemp'],"checked"=> (int)$row['isprevemp']==0 ? false : true ),
			"isSC"		=> array("id"=> (int)$row['sc_stat'],"checked"=> (int)$row['sc_stat']==0 ? false : true ),
			"path_bir"		=> $path_bir,
