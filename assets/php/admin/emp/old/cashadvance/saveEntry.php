...
require_once('../../../email/emailFunction.php');
    ...
    if(!empty($param['accountid'])){
        ...
        $Qry->selected 	= "empid,refferenceno, empname, position, department, datehired, datecreated, timecreated, reason, explanation, loanamount , payabledate, terms, newloanamount, newpayabledate, newterms, loanbalance";
