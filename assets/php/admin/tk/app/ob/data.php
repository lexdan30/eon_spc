...
if(mysqli_num_rows($rs)>= 1){
    ...
    while($row=mysqli_fetch_assoc($rs)){		
        ...
        if(empty($row['approver1_stat'])){
            ...
            $heads_app1 = explode(',',$row['approver1_id']);
        ...
        if(!empty($row['approver1_stat'])){
            ...
            $heads = explode(',',$row['approver2_id']);
        ...
        if(!empty($row['approver2_stat'])){
            ...
            $heads = explode(',',$row['approver3_id']);

            $approver3_count = count($heads);
            if ($approver3_count > 1) {
                if(strpos( $row["approver3_id"], $param['idsuperior'])){
                    $action = 1; 
                }
                $applevel='Level 3';
                ...
                if( $param['idsuperior'] == $row["approver3_id"]){
                    $action = 1; 
                }
                $applevel='Level 3';
        ...
        if(!empty($row['approver3_stat'])){
            ...
            $heads = explode(',',$row['approver4_id']);
 
            $approver4_count = count($heads);
            if ($approver4_count > 1) {
                if(strpos( $row["approver4_id"], $param['idsuperior'])){
                    $action = 1; 
                }
                $applevel='Level 4';
                ...
                if( $param['idsuperior'] == $row["approver4_id"]){
                    $action = 1; 
                }
                $applevel='Level 4';
        ...
        //lex autoapprove for testing
        $approvenext = false;

        if($applevel == 'Level 1'){
            if($row['approver1_id'] == $row['approver2_id']){
                $approvenext = true;
            }
        }elseif($applevel == 'Level 2'){
            if($row['approver2_id'] == $row['approver3_id']){
                $approvenext = true;
            }
        }elseif($applevel == 'Level 3'){
            if($row['approver3_id'] == $row['approver4_id']){
                $approvenext = true;
            }
        }
