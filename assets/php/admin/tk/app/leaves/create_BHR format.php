                        ...
                        if( $date1 <= $date2 ){
                            ...
                            foreach( $param['info']['leave_dates']  as $keys=>$value ){
                                ...
                                if( empty($approver1) ){
                                    ...
                                    $reject[]	= array(
                                        "date"	=> $date,
                                        "msg"	=> "Filing should be 7 days prior to the birth date or 6 days after the date of the birth date."
                                    );
                                } else if (($idleave == 1 || $idleave == 9) && $date > DateTime::createFromFormat("Y-m-d", $date_create)->format('Y-m-d')) {
                                    $reject[]	= array(
                                        "date"	=> $date,
