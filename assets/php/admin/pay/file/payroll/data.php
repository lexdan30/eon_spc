...
if( !empty( $param['period'] ) ){ $search=$search."and pay_date = '". $param['period'] ."' "; }

if($param['flags'] == '1'){
    $search=$search." and period_stat = 'OPEN' ";
}else if($param['flags'] == "" || $param['flags'] == '2' ){
    $search.= " ";
}else{
    $search=$search." and period_stat = 'CLOSED' ";
}
