    ...
    while($row=mysqli_fetch_assoc($rs)){
        ...
        if(!empty($row['approver1_stat'])){
            ...
            if ($approver2_count > 1) {
                if(strpos( $row["approver2"], $param['idsuperior'])){
                    $action = 1; 
                }
                $applevel='Level 2';
        ...
        if(!empty($row['approver2_stat'])){
            ...
            if ($approver3_count > 1) {
                if(strpos( $row["approver3"], $param['idsuperior'])){
                    $action = 1; 
                }
                $applevel='Level 3';
        ...
        if(!empty($row['approver3_stat'])){
            ...
            if ($approver4_count > 1) {
                if(strpos( $row["approver4"], $param['idsuperior'])){
                    $action = 1; 
                }
                $applevel='Level 4';
        ...
        if($applevel == 'Level 1'){
            ...
            if($row['approver2'] == $row['approver3']){
                $approvenext = true;
            }
        }elseif($applevel == 'Level 3'){
            if($row['approver3'] == $row['approver4']){
                $approvenext = true;
            }
        }
