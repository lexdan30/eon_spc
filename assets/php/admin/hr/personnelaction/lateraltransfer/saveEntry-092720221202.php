...
require_once('../../../../email/emailFunction.php');
    ...
    if(!empty($param['accountid'])){
        ...
        $Qry->selected 	= "requestor,refferenceno, empid, empname, effectivedate, empactiontaken, currentdeptname, newdeptname, newiddept, currentdeptmanager, newdeptmanager, newidmngr ,currentimmediatesupervisor, newimmediatesupervisor, newidsuperior, currentsection, newidsection, currentempstatus, newempstatus, currentjobcode, newjobcode, currentjoblevel, newjoblevel, currentpositiontitle, newpositiontitle, currentpaygroup, newpaygroup, currentlabortype, newlabortype, remarks, createdby, date_created, time_created, start_date, end_date, pay_date";
        $Qry->fields 	= " '".$param['entry']['idacct']."',
							...
							if( !empty($param['entry']['newsection']) ){
								$Qry->selected 	= $Qry->selected . ", `newsection`";
