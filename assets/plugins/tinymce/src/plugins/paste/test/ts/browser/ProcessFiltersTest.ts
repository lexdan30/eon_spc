  ...
  TinyLoader.setup(function (editor, onSuccess, onFailure) {
    Pipeline.async({}, [
      ...
      Logger.t('Paste: Paste pre/post process passthough unsafe content', Chain.asStep(editor, [
        cProcessPrePost('<img src="non-existent.webp" onerror="alert(\'!\')">', true, Fun.noop, Fun.noop),
        Assertions.cAssertEq('Should be changed if dangerous content', { content: '<img src="non-existent.webp">', cancelled: false })
      ])),
