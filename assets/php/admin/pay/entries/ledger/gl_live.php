...
$Qry->fields = $Qry->fields . "AND (Debit != ''  AND Debit != '0' OR Credit != '' AND Credit != '0') ORDER BY batchnum ASC,Credit ASC,id ASC LIMIT " .$param->pagination->pageSize. " OFFSET " . ($param->pagination->currentPage - 1) * $param->pagination->pageSize ."";
