...
$Qry->selected  = "a.*,c.name,b.app_first,b.app_second,c.alias";
...
if(mysqli_num_rows($rs)>= 1){
    while($row=mysqli_fetch_array($rs)){
        $data[] = array( 
            ...
            "loantype"                  => $row['name'],
            "app_first"                 => $row['app_first_f'],
            "app_second"                => $row['app_second_f'],
            "alias"                     => $row['alias'],
            "app_first_f"               => array("checked"=> (int)$row['app_first_f']==0 ? false : true),
            "app_second_f"              => array("checked"=> (int)$row['app_second_f']==0 ? false : true),
            "hold"                      => array("checked"=> (int)$row['hold']==0 ? false : true),
            "fullypaid"                  => array("checked"=> (int)$row['fullypaid']==0 ? false : true)
