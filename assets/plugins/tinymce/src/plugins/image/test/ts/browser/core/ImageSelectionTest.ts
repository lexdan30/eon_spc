            ...
            children: [
              s.element('figure', {
                ...
                children: [
                  s.element('img', {
                    attrs: {
                      'src': str.is('updated-image.webp'),
                      'alt': str.is(''),
                      'width': str.is('100'),
                      'height': str.is('100'),
                      'data-mce-src': str.is('updated-image.webp')
                    }
                  }),
                  s.element('figcaption', {
                    attrs: {
