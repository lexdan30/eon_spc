        ...
        if(mysqli_num_rows($rs)>0){
            if($row=mysqli_fetch_array($rs)){
			    ...
			    $data = array(
					...
					'currentimmediatesupervisor' 	=> 	$row['concat_sup_fname_lname'],
					...
					"newsection"                    => '',
					"newempstatus"                  => $row['emp_status'],
					"newjobcode"                    => '',
					"newjoblevel"                   => $row['joblvl'],
					"newpositiontitle"              => '',
					"newpaygroup"                   => $row['pay_grp'],
					"newlabortype"                  => $row['labor_type'],
					"remarks"                       => '',
					"doc"							=> '',
					"effectivedate"					=> '',
					"doc"							=> '',
