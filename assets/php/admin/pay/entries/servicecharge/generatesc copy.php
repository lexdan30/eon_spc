...
$Qry->selected  = "a.id,a.empname,(whrs - SUM(late+ut+`abs`+tc_lwop))  AS totwhrs,(adj_absent - SUM(adj_late + adj_ut + adj_lwop)) + (".$adj_leaves.") AS adj_totwhrs"; //IF(pa.transactiontype = 'UD',pa.amount,0.00) AS uniondues //+ (".$leaves.")
